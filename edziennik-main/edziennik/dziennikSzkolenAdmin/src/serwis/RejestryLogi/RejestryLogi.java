...
public class RejestryLogi {
	...
	public LogiDaneosobowe zapiszLogiOsoba(Timestamp dataFormGlownyTimeStamp,String dzialanie,String sesja,String opis,String users,int idUser,int IdObiektu,String nazwaObiektu) {
