...
/**
 * The persistent class for the plan_zajec database table.
 * 
 */
@Entity
@Table(name="plan_zajec")
@NamedQuery(name="PlanZajec.findAll", query="SELECT p FROM PlanZajec p")
public class PlanZajec implements Serializable {
	...
	public String getZmienione() {
		return this.zmienione;
	}

	public void setZmienione(String zmienione) {
